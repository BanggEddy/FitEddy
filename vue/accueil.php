...
<!-- Page d'accueil -->
  ...
  <br><br>
  Autrement dit, tous les mouvements du corps sollicitant vos muscles.<br><br>
  </div>
  </div>
  <j style="text-align:-moz-center;">
    <div id="carouselExampleControls" class="carousel slide img-thumbnail bg-dark" data-bs-ride="carousel" style="width:50% ;">
